  ...
  return (
    ...
    >
      <p>
        ...
        generator. If you have multiple rehearsal patterns, you will need to run
        this generator a few times.
      </p>
      <p>
        For example: A production begins rehearsal on 3/1/2020. Tech week begins
        4/5/2020. The show opens on 4/10/2020. During normal weeks, the company
        rehearses Sundays from 5:30-9:30, and Monday through Thursday
        6:30-10:30. During tech week, the company rehearses every day from 4-11.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          3/1/2020 to 4/4/2020, Monday, Tuesday, Wednesday, Thursday, 6:30-10:30
        </li>
        <li>
      ...
      <Form noValidate onSubmit={handleSubmit} validated={validated}>
        ...
        <Form.Group>
          <Form.Label>Length of blocks for scheduling rehearsal</Form.Label>
          <InputGroup>
            <Form.Control
            ...
            />
            <InputGroup.Append>
              <InputGroup.Text id="blockLength" type="number">
                minutes
              </InputGroup.Text>
            </InputGroup.Append>
          </InputGroup>
        ...
        <Form.Group>
          <Form.Label>Length of breaks</Form.Label>
          <InputGroup>
            <Form.Control
